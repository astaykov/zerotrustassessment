Describe "Invoke-ZtTenantInfo" {
	...
	BeforeAll {
		...
		if (-not (Get-Command Add-ZtOverviewSensitivityLabelProtection -ErrorAction SilentlyContinue)) {
			function global:Add-ZtOverviewSensitivityLabelProtection {
				param()
			}
		}
	...
	BeforeEach {
		...
		Mock Add-ZtOverviewSensitivityLabelProtection {}
